	...
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
		...
		<div class="m-grid m-grid--hor m-grid--root m-page">
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-grid--tablet-and-mobile m-grid--hor-tablet-and-mobile 		m-login m-login--1 m-login--singin" id="m_login">
						...
						<div class="m-stack__item m-stack__item--fluid">
							<div class="m-login__wrapper">
								<div class="m-login__logo">
									<a href="#">
										<img src="resources/assets/app/media/img//logos/logo_web1.jpg">
									</a>
								</div>
								<div class="m-login__signin">
									...
									<form class="m-login__form m-form" action="">
										...
										<div class="m-login__form-action">
											<button id="m_login_signin_submit" class="btn m-btn--pill    btn-outline-metal m-btn m-btn--custom m-btn--outline-2x">
												Sign In
											</button>
										</div>
									</form>
				...
				<div class="m-grid__item m-grid__item--fluid m-grid m-grid--center m-grid--hor m-grid__item--order-tablet-and-mobile-1	m-login__content" style="background-image: url(resources/assets/app/media/img//bg/bg_5.jpg)">
					<div class="m-grid__item m-grid__item--middle">
						...
						<p class="m-login__msg">
							건강을 기록하세요.
							<br>
							온라인으로 개인트레이너의 관리를 받아보세요.
							당신은 효과적으로 운동할 수 있습니다.
						</p>
					</div>
				</div>
			</div>
		...
		<!--end::Base Scripts -->
		<!--begin::Page Snippets -->
		<script src="resources/assets/snippets/pages/user/login.js?ver=1" type="text/javascript"></script>
		<!--end::Page Snippets -->
	</body>
	<!-- end::Body -->
</html>
